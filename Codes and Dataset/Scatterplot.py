...
d = np.genfromtxt("land-area-and-dwelling-units-by-town.csv", delimiter=',', skip_header=1, skip_footer=243, dtype=[("financial_year","i4"),("town","U18"),("total_land_area","i4"),("residential_land_area","i4"),("dwelling_units_under_management","i4"), ("projected_ultimate_dwelling_units","i4")])
...
plt.scatter(h,y,)
plt.title("Number of units vs Residential Land area in 2008 (Density)", fontsize=18, y=1.03)
